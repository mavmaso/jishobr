...
verb1ga = WordType.create(title: 'verbo ichidan intransitivo/jidoushi', description: 'blabla')
verb1wo = WordType.create(title: 'verbo ichidan transitivo/tadoushi', description: 'blabla')
verb5ga = WordType.create(title: 'verbo godan intransitivo/jidoushi', description: 'blabla')
verb5wo = WordType.create(title: 'verbo godan transitivo/tadoushi', description: 'blabla')
verb0 = WordType.create(title: 'verbo irregular', description: 'blabla')
adv = WordType.create(title: 'adverbio')
noun = WordType.create(title:'substantivo')
adji = WordType.create(title: 'adjetivo i')
adjna = WordType.create(title: 'adjetivo na')
